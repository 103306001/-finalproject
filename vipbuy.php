...
<?php
    ...
    mysqli_close($db);
    $memDiscountPrice = round($memDiscount * $Price);
?>
    <!DOCTYPE html>
    <html lang="en">
    <meta charset="utf-8">
                                    ...
                                    <form method="post" action="confirmbuy.php">
                                        <table class="table table-hover">
                                           ...
                                           <tr>
                                            ...
                                            <tr>
                                                <td>原價</td>
                                                <td style="color:#9D9D9D;"><p><del>$<?php echo "$Price";?></del></p>  
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>特價</td>
                                                <td style="color:red;"><p>$<?php echo "$memDiscountPrice";?></p>  
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>數量</td>
                                        ...
                                        <input type="hidden" name="price" value="<?php echo "$memDiscountPrice";?>">
                                        <input class="btn btn-primary btn-block" type="submit" value="確認購買">
                                    </form>
                                </div>
                            </div>
                    </div>
