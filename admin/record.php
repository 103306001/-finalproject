            ...
            <div class="col-md-9">
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            <input class="form-control" id="id" name="id" placeholder="商品ID" type="text" required>
                        </div>
                    ...
                    <div class="row" style="margin-top:1%;">
                        <form method="post" action="recordresult.php">
                        <div class="col-sm-6 form-group">
                            <input class="form-control" id="name" name="name" placeholder="商品名稱" type="text" required>
                        </div>
                        <div class="col-sm-2 form-group">
                            <input class="btn btn-primary btn-block" type="submit" value="查詢"></input>
                        </div>
                    ...
                    <div class="row" style="margin-top:1%;">
                        <form method="post" action="recordresult.php">
                        <div class="col-sm-6 form-group">
                            <input class="form-control" id="singer" name="singer" placeholder="品牌名稱" type="text" required>
                        </div>
                        <div class="col-sm-2 form-group">
                            <input class="btn btn-primary btn-block" type="submit" value="查詢"></input>
                        </div>
